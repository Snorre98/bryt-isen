...
#     while allowing anyone to report the activity.
#     """
...
#         Allow the owner to edit or delete the activity,
#         while allowing other users to read it.
#         """
#         if request.method in permissions.SAFE_METHODS:
#             return True  # Allow safe methods like GET, HEAD, or OPTIONS
...
class CanReportActivity(permissions.BasePermission):
    "Custom permission to allow anyone to report an activity."

    def has_permission(self, request, view):  # noqa: ANN201, PLR0917
        # Allow any authenticated user to report the activity
        return request.user.is_authenticated
